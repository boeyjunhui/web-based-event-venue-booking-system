...
@section('content')
    ...
    <div class="p-4 bg-white rounded-lg mt-6">
        <div class="grid justify-items-start">
            <h1 class="content-center text-2xl font-bold text-gray-800 mt-2 mb-2">Add Super Admin</h1>
        </div>

        <form action="/evbs/super-admins/create" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-8 mt-20 mb-6">
                ...
                <div class="grid justify-items-start">
                    <a href="/evbs/super-admins" class="p-2 w-40 text-center text-sm text-white rounded-md bg-red-500 hover:bg-red-700 transition">Cancel</a>
                </div>
            </div>
        </form>
    </div>
