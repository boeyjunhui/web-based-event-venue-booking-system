            ...
            <div class="w-full bg-white rounded-2xl shadow-xl sm:max-w-md">
                <div class="p-6">
                    ...
                    <div class="grid justify-items-center">
                        <a href="{{ route('displayResetPasswordForm', $token) }}" class="p-2.5 w-36 text-sm text-white text-center rounded-lg bg-indigo-500 hover:bg-indigo-700 transition mb-8">Reset Password Link</a>
                    </div>
