...
@section('content')
    <p class="text-gray-400"><a href="/evbs/event-venues" class="hover:underline hover:text-teal-500 transition">Event Venues</a> / <span class="text-teal-500">Add Event Venue</span></p>

    <div class="p-4 bg-white rounded-lg mt-6">
        <div class="grid justify-items-start">
            <h1 class="content-center text-2xl font-bold text-gray-800 mt-2 mb-2">Add Event Venue</h1>
        </div>

        <form action="/evbs/event-venues/create" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <select class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" id="select-event-venue-owner" name="eventVenueOwner">
                            ...
                            @foreach ($eventVenueOwners as $eventVenueOwner)
                                <option value="{{ $eventVenueOwner->id }}">{{ $eventVenueOwner->first_name }} {{ $eventVenueOwner->last_name }} ({{ $eventVenueOwner->email }})</option>
                            @endforeach
                        </select>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <input type="text" class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="eventVenueName" value="{{ old('eventVenueName') }}">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <input type="email" class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="eventVenueEmail" value="{{ old('eventVenueEmail') }}">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <input type="text" class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="eventVenuePhoneNumber" value="{{ old('eventVenuePhoneNumber') }}">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <textarea class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="eventVenueDescription" rows="5">{{ old('eventVenueDescription') }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <input type="number" class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="sizeMeasurement" value="{{ old('sizeMeasurement') }}">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <input type="number" class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="maximumGuests" value="{{ old('maximumGuests') }}">
                    @error('maximumGuests')
                        <div></div>
                        <div>
                            <p class="text-sm font-medium text-red-500 text-right">{{ $message }}</p>
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <textarea class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="availability" rows="3">{{ old('availability') }}</textarea>
                    @error('availability')
                        <div></div>
                        <div>
                            <p class="text-sm font-medium text-red-500 text-right">{{ $message }}</p>
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <textarea class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="packagesPricing" rows="6">{{ old('packagesPricing') }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <textarea class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="amenities" rows="6">{{ old('amenities') }}</textarea>
                    @error('amenities')
                        <div></div>
                        <div>
                            <p class="text-sm font-medium text-red-500 text-right">{{ $message }}</p>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <textarea class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="accessibility" rows="6">{{ old('accessibility') }}</textarea>
                    @error('accessibility')
                        <div></div>
                        <div>
                            <p class="text-sm font-medium text-red-500 text-right">{{ $message }}</p>
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 mb-6">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <textarea class="p-2 text-sm text-gray-800 border border-gray-300 rounded-md" name="addOnServices" rows="6">{{ old('addOnServices') }}</textarea>
                    @error('addOnServices')
                        <div></div>
                        <div>
                            <p class="text-sm font-medium text-red-500 text-right">{{ $message }}</p>
            ...
            <div class="grid grid-cols-2 gap-8 mt-20 mb-6">
                ...
                <div class="grid justify-items-start">
                    <a href="/evbs/event-venues" class="p-2 w-40 text-center text-sm text-white rounded-md bg-red-500 hover:bg-red-700 transition">Cancel</a>
                </div>
            </div>
        </form>
    </div>
