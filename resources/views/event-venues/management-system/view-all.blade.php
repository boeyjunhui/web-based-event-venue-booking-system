    ...
    <div class="p-4 bg-white rounded-lg mt-2">
        <div class="grid grid-cols-2 mb-6 items-center">
            ...
            <div class="grid justify-items-end">
                <a href="/evbs/event-venues/add"><button type="submit" class="p-1 w-16 text-2xl text-white rounded-md bg-teal-500 hover:bg-teal-700 transition"><i class="bx bx-plus"></i></button></a>
            </div>
        </div>
                    ...
                    <tbody class="text-gray-800 bg-neutral-50">
                        ...
                        @forelse ($eventVenues as $eventVenue)
                            <tr class="hover:bg-neutral-200 transition">
                                ...
                                <td>{{ $eventVenue->created_at }}</td>
                                <td>{{ $eventVenue->updated_at }}</td>
                            </tr>
                            ...
                            <script>
                                document.getElementById('activate-confirmation-{{ $no }}')?.addEventListener('click', function () {
                                    ...
                                    Swal.fire({
                                        titleText: 'Activate',
                                        text: "Are you sure you want to activate {{ $eventVenue->event_venue_name }}?",
                                        icon: 'question',
                            ...
                            <script>
                                document.getElementById('deactivate-confirmation-{{ $no }}')?.addEventListener('click', function () {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: "Are you sure you want to deactivate {{ $eventVenue->event_venue_name }}?",
                                        icon: 'warning',
                                        showConfirmButton: true,
                                        showCancelButton: true,
                                        color: '#1f2937',
                            ...
                            <script>
                                document.getElementById('delete-confirmation-{{ $no }}')?.addEventListener('click', function () {
                                    ...
                                    Swal.fire({
                                        titleText: 'Delete',
                                        text: "Are you sure you want to delete {{ $eventVenue->event_venue_name }}?",
                                        icon: 'warning',
                                        showConfirmButton: true,
                                        showCancelButton: true,
                                        color: '#1f2937',
